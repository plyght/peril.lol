      ...
      <div className="relative z-10">
        ...
        <div className="max-w-[700px]">
          <div className="reveal reveal-d2 mb-[4vh]">
            <h1 className="serif text-[clamp(24px,3vw,34px)] leading-[1.3] tracking-[-0.015em] font-medium">
              {post.title}
            </h1>
            <span
          ...
          <article
            className="reveal reveal-d3 serif text-[clamp(18px,1.6vw,20px)] leading-[1.75] tracking-[-0.005em]"
